...
| 4 | **Assets follow-ups** — reconcile paid-but-undelivered purchases from before #334 (every paid domain→NFT mint: the BFF answered 400) against payment-service; Tec-Assets `assets/transfer` calls a route asset-service does not have; no UI entry point for domain registration (`AddDomainModal` is mounted nowhere) | Payment integrity itself is closed and runtime-verified 24 Sep (#334 · #336 · #337) — these are the leftovers | 56r |
