...
| 4 | **Assets: reconcile what was paid and never delivered** — domain→NFT mints paid **30 May → 24 Sep** (the follow-up answered 400; before 30 May it worked). Run the read-only report (backend #339) in asset-service's Console: `node dist/scripts/reconcile-purchases.js --from 2026-05-30 --to 2026-09-25`, then deliver or refund each case through PurchaseService | Real π taken, nothing delivered | 56r |
