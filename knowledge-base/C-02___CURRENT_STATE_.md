...
- **Alert** — Pro = badge only; a genuine feature (personal watchlist/reminders) is buildable but not yet done.
...
### PR ledger
tec-explorer **#21** · tec-zone **#26** · tec-estate **#19**. No backend/DB change (all read existing
data). All local suites + typecheck green.
