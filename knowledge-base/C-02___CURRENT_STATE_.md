...
|---|---|---|---|
| 1 | **Phone checks**: Hub keeps the name a day after sign-in (#256)? "Try again" recovers a silent Pi (#253)? An app opened from the Quest signs itself in (C-123 §10) — FundX on the first try, Explorer on the fourth: which app was opened just before? | Only a device can answer; record in C-123 §9/§10 | 56p · 56q · 56r |
