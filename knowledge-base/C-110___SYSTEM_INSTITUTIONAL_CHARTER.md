...
**System is deployed on Mainnet** with Hub SSO and dual-mode (ADR-007) Pi payment live:
- **Domain:** `system.tecosystem.app` · **Pi App ID:** `system-qbz2` · **APP_SOURCE:** `system`
- **Payment:** real Pi subscription — Mode 1 (Hub) + Mode 2 (standalone); `PI_API_KEY_SYSTEM` set on payment-service.
