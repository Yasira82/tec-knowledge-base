...
| 7 | إنشاء C-doc مستقل لـ `tec-auth` package | C-23 أو C-24 جديد — **اتقفل من غير doc جديد (24 Sep 2026):** الـ package متوثّق في C-14 §1 (الإصدار) و C-13 §6 (الـ API)، ورقم 24 ماتعملش |
