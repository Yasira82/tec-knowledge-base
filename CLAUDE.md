...
> — the same check `drift.yml` runs every Monday. The tables in C-11 (repos) and C-44 (env
> vars) are **generated**: `python3 scripts/generate-code-docs.py --repos-dir … --ref origin/main`.
